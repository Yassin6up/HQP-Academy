...
const forms = new inputs(
  ...
  `<button type="submit" id='NextBtn' class="BtnLearn" data-lang="Next" >Next</button>`
);
forms.confirmBtn = `<button type="submit" id='Next2Btn' class="BtnLearn"  data-lang="Next">Next</button>`;
console.log("its run");
// start
      ...
      document.getElementById("Next2Btn").addEventListener("click", () => {
        ...
        chekboxList.some((el) => {
          if (el.checked === false) {
            ...
            let confirmBtn = `<button id="confirm" type="submit" class="BtnLearn confirm" data-lang="Confirm">Confirme</button>`;
            ...
            document.getElementById("confirm").onclick = () => {
              ...
              let booked = `<h1 class='booked'>${localStorage.getItem(
                "Pack2"
              )}</h1>`;
              emailSend(domains);
